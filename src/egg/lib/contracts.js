...
import EggAbi from './abi/egg.json'
...
export class Contracts {
  constructor(provider, networkId, web3, options) {
    ...
    this.egg = new this.web3.eth.Contract(EggAbi)
  ...
  setProvider(provider, networkId) {
    ...
    setProvider(this.egg, contractAddresses.egg[networkId])
